...
commonTypes::sender::bool_t CMapperToLedCommand::mapGroupToHex(ILEDInterface::eGroup a_eGroup, commonTypes::limitless::eGroupOn &a_eHEX)
{
    commonTypes::sender::bool_t fRetVal = true;

    switch(a_eGroup)
    {
        case ILEDInterface::E_GROUP_ALL:
        {
            a_eHEX = commonTypes::limitless::E_GROUP_ALL_ON;
        }
        break;

        case ILEDInterface::E_GROUP_1:
        {
            a_eHEX = commonTypes::limitless::E_GROUP_1_ON;
        }
        break;

        case ILEDInterface::E_GROUP_2:
        {
            a_eHEX = commonTypes::limitless::E_GROUP_2_ON;
        }
        break;

        case ILEDInterface::E_GROUP_3:
        {
            a_eHEX = commonTypes::limitless::E_GROUP_3_ON;
        }
        break;

        case ILEDInterface::E_GROUP_4:
        {
...
commonTypes::sender::bool_t CMapperToLedCommand::mapGroupToHex(ILEDInterface::eGroup a_eGroup, commonTypes::limitless::eGroupOff &a_eHEX)
{
    commonTypes::sender::bool_t fRetVal = true;
...
commonTypes::sender::bool_t CMapperToLedCommand::mapGroupToHex(ILEDInterface::eGroup a_eGroup, commonTypes::limitless::eSetWhiteCol &a_eHEX)
{
    commonTypes::sender::bool_t fRetVal = true;
